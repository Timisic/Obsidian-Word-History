"""CLI for building local word-history SVG artifacts."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build a local Obsidian Git word-history SVG.")
...
def _count_config_from_args(args: argparse.Namespace) -> CountConfig | None:
    if not any(
        [
